<?php
namespace desrodman\localeurls;
...
class UrlManager extends BaseUrlManager
{
    ...
    protected function detectLanguage()
    {
        if ($this->enableLanguageDetection) {
            $languageAcceptableList = $this->_request->getAcceptableLanguages();
            if(in_array($this->_defaultLanguage, $languageAcceptableList))
                return $this->_defaultLanguage;
            else
            {
                foreach ($languageAcceptableList as $acceptable) {
