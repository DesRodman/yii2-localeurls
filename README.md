...
[![Build Status](https://secure.travis-ci.org/desrodman/yii2-localeurls.png)](http://travis-ci.org/desrodman/yii2-localeurls)
[![Latest Stable Version](https://poser.pugx.org/desrodman/yii2-localeurls/v/stable.svg)](https://packagist.org/packages/desrodman/yii2-localeurls)
[![Total Downloads](https://poser.pugx.org/desrodman/yii2-localeurls/downloads)](https://packagist.org/packages/desrodman/yii2-localeurls)
[![Latest Unstable Version](https://poser.pugx.org/desrodman/yii2-localeurls/v/unstable.svg)](https://packagist.org/packages/desrodman/yii2-localeurls)
[![License](https://poser.pugx.org/desrodman/yii2-localeurls/license.svg)](https://packagist.org/packages/desrodman/yii2-localeurls)
...
Install the package through [composer](http://getcomposer.org):
    ...
    composer require desrodman/yii2-localeurls
...
return [
    ...
    'components' => [
        ...
        'urlManager' => [
            'class' => 'desrodman\localeurls\UrlManager',
